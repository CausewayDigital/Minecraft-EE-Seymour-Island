...
execute @e[type=armor_stand, tag=crypto_vault] ~ ~ ~ execute @p[x=~1, y=~6, z=~6, dx=-2, dy=3, dz=1, scores={crypto_v_done=1}] ~ ~ ~ execute @e[type=armor_stand, tag=crypto_vault, c=1] ~ ~ ~ function cryptovault/reset
execute @e[type=armor_stand, tag=crypto_vault] ~ ~ ~ execute @p[x=~1, y=~6, z=~6, dx=-2, dy=3, dz=1, scores={crypto_v_done=1}] ~ ~ ~ tp @s -465 59 205 facing -465 59 203
