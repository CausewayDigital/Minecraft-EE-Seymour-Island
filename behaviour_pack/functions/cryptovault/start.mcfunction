...
# Room 0-1-0
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -460 30 223 air -1 execute @e[type=armor_stand, tag=crypto_vault, x=-466, y=20, z=220, r=1, c=1] ~ ~ ~ function cryptovault/reset
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -460 30 223 air -1 scoreboard players set @s task_start_timer 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -460 30 223 air -1 scoreboard players set @s task_timer_act 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -460 30 223 air -1 tp @s -466 29 217 facing -466 29 219
...
# Room 1-1-0
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -435 30 223 air -1 execute @e[type=armor_stand, tag=crypto_vault, x=-441, y=20, z=220, r=1, c=1] ~ ~ ~ function cryptovault/reset
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -435 30 223 air -1 scoreboard players set @s task_start_timer 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -435 30 223 air -1 scoreboard players set @s task_timer_act 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -435 30 223 air -1 tp @s -441 29 217 facing -441 29 219
...
# Room 2-1-0
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -410 30 223 air -1 execute @e[type=armor_stand, tag=crypto_vault, x=-416, y=20, z=220, r=1, c=1] ~ ~ ~ function cryptovault/reset
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -410 30 223 air -1 scoreboard players set @s task_start_timer 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -410 30 223 air -1 scoreboard players set @s task_timer_act 1
execute @s[x=-445, y=67, z=211, dx=-20, dy=4, dz=-15] ~ ~ ~ detect -410 30 223 air -1 tp @s -416 29 217 facing -416 29 219
