...
# Task 5
execute @s[scores={in_task=1}] ~ ~ ~ execute @e[type=armor_stand, tag=task_5, r=12, c=1] ~ ~ ~ execute @p[x=~-10, y=~1, z=~-11, dx=14, dy=5, dz=18, scores={phone_selected=1}] ~ ~ ~ scoreboard players set @s task_start_timer 1
execute @s[scores={in_task=1}] ~ ~ ~ execute @e[type=armor_stand, tag=task_5, r=12, c=1] ~ ~ ~ tp @p[x=~-10, y=~1, z=~-11, dx=14, dy=5, dz=18, scores={phone_selected=1}] ~ ~2 ~2 facing ~ ~ ~6
