...
# Set variables back
execute @s[scores={flying_enabled=2}] ~ ~ ~ scoreboard players set @s flying_enabled 0
execute @s[scores={flying_enabled=3}] ~ ~ ~ scoreboard players set @s flying_enabled 1
