...
execute @s ~ ~ ~ detect ~-6 ~3 ~2 redstone_wire -1 execute @p[scores={task_1_rs_1_done=0}, x=~-9, y=~2, z=~-7, dx=15, dy=8, dz=13] ~ ~ ~ title @s actionbar Damaged section 1 repaired!
...
execute @s ~ ~ ~ detect ~-5 ~3 ~-1 redstone_wire -1 execute @p[scores={task_1_rs_2_done=0}, x=~-9, y=~2, z=~-7, dx=15, dy=8, dz=13] ~ ~ ~ title @s actionbar Damaged section 2 repaired!
...
execute @s ~ ~ ~ detect ~-6 ~3 ~-2  redstone_wire -1 execute @p[scores={task_1_rs_3_done=0}, x=~-9, y=~2, z=~-7, dx=15, dy=8, dz=13] ~ ~ ~ title @s actionbar Damaged section 3 repaired!
