...
execute @a[scores={task_start_timer=10}] ~ ~ ~ execute @e[type=armor_stand, tag=task_8, r=8, c=1] ~ ~ ~ execute @a[x=~-8, y=~3, z=~5, dx=14, dy=3, dz=8] ~ ~ ~ scoreboard players set @s in_task 1
