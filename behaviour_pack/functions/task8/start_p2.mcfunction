...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=1}] ~ ~ ~ detect -438 57 279 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=2}] ~ ~ ~ detect -438 57 259 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=3}] ~ ~ ~ detect -438 42 279 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=4}] ~ ~ ~ detect -438 42 259 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=5}] ~ ~ ~ detect -438 27 279 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-444, y=82, z=273, dx=-12, dy=4, dz=12, scores={task_room_num=6}] ~ ~ ~ detect -438 27 259 air -1 scoreboard players set @s task_timer_act 1
