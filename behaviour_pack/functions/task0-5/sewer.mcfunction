...
execute @a[x=-323, y=62, z=282, dx=24, dy=4, dz=-6, scores={task_0-5_sews=0}] ~ ~ ~ playsound cd.sewer.sewer @s -312 63 278
execute @a[x=-323, y=62, z=282, dx=24, dy=4, dz=-6, scores={task_0-5_sews=0}] ~ ~ ~ scoreboard players set @s task_0-5_sews 1
...
execute @a[scores={task_0-5_sews=1, task_0-5_sewst=1150}] ~ ~ ~ playsound cd.sewer.sewer @s -312 63 278
