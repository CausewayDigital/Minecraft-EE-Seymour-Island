...
execute @p[x=-323, y=62 , z=282, dx=28, dy=4, dz=-6, scores={task0-5_ss=0}] ~ ~ ~ playsound ambient.sewer.sewer @p -312 63 278
execute @p[x=-323, y=62 , z=282, dx=28, dy=4, dz=-6, scores={task0-5_ss=0}] ~ ~ ~ scoreboard players set @p task_0-5_ss 1
execute @p[scores={task0-5_ss=1}] ~ ~ ~ scoreboard players add @p task_0-5_sstimer 1
...
execute @p[scores={task0-5_ss=1, task_0-5_sstimer=1650}] ~ ~ ~ scoreboard players set @p task_0-5_ss 0
execute @p[scores={task0-5_ss=0, task_0-5_sstimer=1650}] ~ ~ ~ scoreboard players set @p task_0-5_sstimer 0