...
execute @a[scores={task_0-5_sews=0, task_0-5_sewpos=3}] ~ ~ ~ scoreboard players set @p task_0-5_sewpos 1

# if the player enters the sewer play the sound at the position specified by the tick timer
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6, scores={task_0-5_sews=0, task_0-5_sewst=1}] ~ ~ ~ playsound cd.sewer.sewer @p -304 63 278
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6, scores={task_0-5_sews=0, task_0-5_sewst=2}] ~ ~ ~ playsound cd.sewer.sewer @p -312 63 278
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6, scores={task_0-5_sews=0, task_0-5_sewst=3}] ~ ~ ~ playsound cd.sewer.sewer @p -317 63 278
