...
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6] ~ ~ ~ playsound cd.sewer.sewer @p -312 63 278
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6] ~ ~ ~ scoreboard players set @p task_0-5_ss 1
...
execute @a[scores={task_0-5_ss=0, task_0-5_sstimer=1650}] ~ ~ ~ scoreboard players set @p task_0-5_sstimer 0
