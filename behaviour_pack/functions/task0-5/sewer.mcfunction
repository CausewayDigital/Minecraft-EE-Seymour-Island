...
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6, scores={task_0-5_ss=0}] ~ ~ ~ playsound cd.sewer.sewer @p -312 63 278
execute @a[x=-323, y=62 , z=282, dx=24, dy=4, dz=-6, scores={task_0-5_ss=0}] ~ ~ ~ scoreboard players set @p task_0-5_ss 1
execute @a[scores={task_0-5_ss=1}] ~ ~ ~ scoreboard players add @p task_0-5_sstimer 1
...
execute @a[scores={task_0-5_ss=1, task_0-5_sstimer=1150}] ~ ~ ~ playsound cd.sewer.sewer @p -312 63 278
execute @a[scores={task_0-5_ss=1, task_0-5_sstimer=1150}] ~ ~ ~ scoreboard players set @p task_0-5_sstimer 0
...
execute @a[x=-298, y=62, z=277, dx=4, dy=4, dz=2] ~ ~ ~ scoreboard players set @p task_0-5_ss 0
execute @a[x=-298, y=62, z=277, dx=4, dy=4, dz=2] ~ ~ ~ scoreboard players set @p task_0-5_sstimer 0
