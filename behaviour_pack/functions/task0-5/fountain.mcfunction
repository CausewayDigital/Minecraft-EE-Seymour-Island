...
execute @a[x=-440, y=60 , z=243, dx=-12, dy=4, dz=-9, scores={task_0-5_ss=0}] ~ ~ ~ playsound cd.sewer.sewer @p -441 61 237
execute @a[x=-440, y=60 , z=243, dx=-12, dy=4, dz=-9, scores={task_0-5_ss=0}] ~ ~ ~ scoreboard players set @p task_0-5_ss 1
...
execute @a[scores={task_0-5_ss=1, task_0-5_sstimer=1150}] ~ ~ ~ playsound cd.sewer.sewer @p -441 61 237
...
execute @a[x=-448, y=67, z=239, dx=-4, dy=6, dz=-4] ~ ~ ~ scoreboard players set @p task_0-5_ss 0
execute @a[x=-448, y=67, z=239, dx=-4, dy=6, dz=-4] ~ ~ ~ scoreboard players set @p task_0-5_sstimer 0
