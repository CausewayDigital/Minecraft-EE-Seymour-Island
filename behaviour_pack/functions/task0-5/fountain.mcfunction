...
execute @p[x=-448, y=67, z=239, dx=-4, dy=6, dz=-4, scores={task_0-5_fon=0}] ~ ~ ~ codebuilder navigate @p true https://minecraft.makecode.com/?ipc=1&lockedEditor=1&inGame=1#tutorial:65032-59521-80748-64139
