...
execute @a[scores={task_start_timer=8}] ~ ~ ~ execute @e[type=armor_stand, tag=task_0, r=20, c=1] ~ ~ ~ execute @p[x=~-4, y=~0, z=~-16, dx=10, dy=8, dz=26] ~ ~ ~ dialogue open @e[type=npc, tag=papert, c=1] @s task_0_intro
