...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=1}] ~ ~ ~ detect -467 57 271 air -1 scoreboard players set @s task_timer_active 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=2}] ~ ~ ~ detect -467 57 251 air -1 scoreboard players set @s task_timer_active 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=3}] ~ ~ ~ detect -467 42 271 air -1 scoreboard players set @s task_timer_active 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=4}] ~ ~ ~ detect -467 42 251 air -1 scoreboard players set @s task_timer_active 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=5}] ~ ~ ~ detect -467 27 271 air -1 scoreboard players set @s task_timer_active 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=6}] ~ ~ ~ detect -467 27 251 air -1 scoreboard players set @s task_timer_active 1
