...
execute @e[type=armor_stand, tag=task_6] ~ ~ ~ execute @p[x=~5, y=~3, z=~-4, dx=1, dy=3, dz=7] ~ ~ ~ scoreboard players set @s task_7_player 1
# Mark player as player 1
execute @e[type=armor_stand, tag=task_6] ~ ~ ~ execute @p[x=~3, y=~5, z=~3, dx=-8, dy=3, dz=-7] ~ ~ ~ scoreboard players set @s task_7_player 2
...
execute @a[scores={task_start_timer=10}] ~ ~ ~ execute @e[type=armor_stand, tag=task_7, r=8, c=1] ~ ~ ~ execute @a[x=~6, y=~3, z=~-4, dx=-11, dy=3, dz=4] ~ ~ ~ scoreboard players set @s in_task 1
