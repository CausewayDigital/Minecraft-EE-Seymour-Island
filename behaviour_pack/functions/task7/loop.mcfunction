...
execute @a[scores={task_start_timer=10}] ~ ~ ~ execute @e[type=armor_stand, tag=task_7, r=8, c=1] ~ ~ ~ execute @a[x=~6, y=~2, z=~-4, dx=-11, dy=4, dz=8] ~ ~ ~ scoreboard players set @s in_task 1
