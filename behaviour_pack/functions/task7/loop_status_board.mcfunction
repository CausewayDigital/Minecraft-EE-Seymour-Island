...
execute @s ~ ~ ~ detect -477 60 284 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 60 284 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 283

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 283

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 283

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 283
...
execute @s ~ ~ ~ detect -477 60 264 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 60 264 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
# Set Signs
# If neither is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 282

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 282

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 282

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=54, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 282
...
execute @s ~ ~ ~ detect -477 45 284 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 45 284 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
# Set Signs
# If neither is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 281

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 281

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 281

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 281
...
execute @s ~ ~ ~ detect -477 45 264 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 45 264 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
# Set Signs
# If neither is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 280

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 280

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 280

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=39, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 280
...
execute @s ~ ~ ~ detect -477 30 284 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 30 284 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
# Set Signs
# If neither is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 279

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 279

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 279

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=275, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 279
...
execute @s ~ ~ ~ detect -477 30 264 barrel -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 1
...
execute @s ~ ~ ~ detect -477 30 264 air -1 execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1] ~ ~ ~ scoreboard players set @s p2_state_cur 0
...
# Set Signs
# If neither is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 248 -510 76 248 -457 78 278

# If 1 is free and 2 is in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1, scores={p1_state_cur=0, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 247 -510 76 247 -457 78 278

# If 1 is in use and 2 is free
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=0, update_signs=1}] ~ ~ ~ clone -510 76 246 -510 76 246 -457 78 278

# If both 1 and 2 are in use
execute @e[type=armor_stand, tag=task_7, x=-472, y=24, z=255, c=1, scores={p1_state_cur=1, p2_state_cur=1, update_signs=1}] ~ ~ ~ clone -510 76 245 -510 76 245 -457 78 278
