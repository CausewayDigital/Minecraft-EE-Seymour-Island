...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=1}] ~ ~ ~ detect -477 60 284 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=2}] ~ ~ ~ detect -477 60 264 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=3}] ~ ~ ~ detect -477 45 284 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=4}] ~ ~ ~ detect -477 45 264 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=5}] ~ ~ ~ detect -477 30 284 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-445, y=77, z=272, dx=-10, dy=3, dz=14, scores={task_room_num=6}] ~ ~ ~ detect -477 30 264 air -1 scoreboard players set @s task_timer_act 1
