...
execute @s[scores={crypto_score=4}] ~ ~ ~ title @s title Correct
execute @s[scores={crypto_score=4}] ~ ~ ~ title @s subtitle Write down the codeword as you might need it later
