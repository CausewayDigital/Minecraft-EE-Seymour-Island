...
execute @s[scores={crypto_timer=0}] ~ ~ ~ execute @p[scores={crypto_cmplt_1=0}] ~ ~ ~ function crypto/input/robot_1/incorrect
execute @s[scores={crypto_timer=!0}] ~ ~ ~ title @s UNAVAILABLE
execute @s[scores={crypto_timer=!0}] ~ ~ ~ subtitle @s try again later
