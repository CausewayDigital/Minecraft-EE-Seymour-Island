...
execute @e[type=armor_stand, tag=task_6, r=8] ~ ~ ~ execute @p[x=~6, y=~5, z=~-1, dx=-5, dy=3, dz=2] ~ ~ ~ execute @e[type=armor_stand, tag=task_6, r=8] ~ ~ ~ function task6/reset
execute @e[type=armor_stand, tag=task_6, r=8] ~ ~ ~ execute @p[x=~6, y=~5, z=~-1, dx=-5, dy=3, dz=2] ~ ~ ~ function task4/reset_agent
