...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=1}] ~ ~ ~ detect -501 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=2}] ~ ~ ~ detect -501 42 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=3}] ~ ~ ~ detect -524 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=4}] ~ ~ ~ detect -524 42 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=5}] ~ ~ ~ detect -547 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=6}] ~ ~ ~ detect -547 42 256 air -1 scoreboard players set @s task_timer_act 1
