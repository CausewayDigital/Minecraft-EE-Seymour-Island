...
execute @a[x=~6, y=~5, z=~-1, dx=-13, dy=3, dz=3] ~ ~ ~ execute @e[type=armor_stand, tag=task_6, c=1] ~ ~ ~ detect ~6 ~3 ~-7 lit_restone_lamp -1 scoreboard players add @s task_6_prog 1
