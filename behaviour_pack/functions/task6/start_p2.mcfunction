...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=1}] ~ ~ ~ detect -515 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=2}] ~ ~ ~ detect -515 42 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=3}] ~ ~ ~ detect -538 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=4}] ~ ~ ~ detect -538 42 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=5}] ~ ~ ~ detect -561 62 256 air -1 scoreboard players set @s task_timer_act 1
...
execute @s[x=-501, y=68, z=238, dx=-12, dy=3, dz=12, scores={task_room_num=6}] ~ ~ ~ detect -561 42 256 air -1 scoreboard players set @s task_timer_act 1
