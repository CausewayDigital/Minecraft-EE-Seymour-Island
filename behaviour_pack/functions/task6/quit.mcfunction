...
# Player 1
execute @e[type=armor_stand, tag=task_6, r=8] ~ ~ ~ execute @p[x=~7, y=~5, z=~-1, dx=-5, dy=3, dz=3, scores={phone_selected=1}] ~ ~ ~  execute @e[type=armor_stand, tag=task_6, c=1] ~ ~ ~ function task6/reset
# Player 2
