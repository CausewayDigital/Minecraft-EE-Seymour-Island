...
execute @s[x=-492, y=40, z=192, dx=-22, dy=4, dz=23] ~ ~ ~ detect -532 34 235 air -1 scoreboard players set @s task_start_timer 1
execute @s[x=-492, y=40, z=192, dx=-22, dy=4, dz=23] ~ ~ ~ detect -532 34 235 air -1 scoreboard players set @s task_4_timer 0
