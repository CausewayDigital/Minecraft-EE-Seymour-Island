...
execute @a[scores={in_task=1, task_4_timer=10..1010}] ~ ~ ~ execute @e[type=armor_stand, tag=task_4, r=8, c=1] ~ ~ ~ detect ~6 ~3 ~-4 stone_pressure_plate 1 execute @p[x=~7, y=~3, z=~-5, dx=-16, dy=2, dz=7] ~ ~ ~ scoreboard players set @s task_4_fail 1
